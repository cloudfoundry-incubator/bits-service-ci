...
etcd_version=$(curl -s https://github.com/cloudfoundry/cf-release/releases | sed -n 's/.*etcd release <a href="https:\/\/github.com\/cloudfoundry-incubator\/etcd-release\/tree\/v\([0-9\.]*\)">.*/\1/p' | head -1)
